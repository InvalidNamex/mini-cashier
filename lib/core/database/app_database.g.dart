...
class Order extends DataClass implements Insertable<Order> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, cashierId, createdAt, status, total, notes);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Order &&
...
class $$OrdersTableTableManager
    extends
        RootTableManager<
          ...
          Order,
          PrefetchHooks Function({bool cashierId, bool orderItemsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({cashierId = false, orderItemsRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [if (orderItemsRefs) db.orderItems],
              addJoins:
